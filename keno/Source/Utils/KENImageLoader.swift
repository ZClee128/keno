...
class KENImageLoader {
    static let shared = KENImageLoader()
    ...
    func loadImage(from urlString: String, completion: @escaping (UIImage?) -> Void) {
        ...
        if !urlString.hasPrefix("http://") && !urlString.hasPrefix("https://") {
            ...
            let docPath = KENPersistenceManager.shared.getDocumentsDirectory().appendingPathComponent(fileName).path
