...
enum KENPolicyType {
    ...
    var content: String {
        ...
        case .terms:
            return """
KENO - Terms of Service and Privacy Policy

Last Updated: January 2026

Welcome to KENO! Explore the world of reptiles responsibly and enjoy the community.

1. Terms of Service

1. Service Description
KENO is a reptile sharing social platform where users can post photos/videos of their pets, share care tips, and connect with other enthusiasts.
...
class KENPolicyViewController: UIViewController {
    private let type: KENPolicyType
