...
class KENCreatePostViewController: UIViewController, UITextViewDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {

    private var selectedImage: UIImage?

    private let textView: UITextView = {
        let tv = UITextView()
        tv.font = KENConstants.Fonts.regular(size: 16)
    ...
    private let imageView: UIImageView = {
        ...
        iv.tintColor = KENConstants.Colors.reptileGreen
    ...
    @objc private func didTapPost() {
        ...
        KENPostManager.shared.addPost(image: image, caption: caption)
