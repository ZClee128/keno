...
class KENPostDetailViewController: UIViewController {
    ...
    private let videoPlayerView = KENVideoPlayerView()
    ...
    private let nameLabel: UILabel = {
        let label = UILabel()
        label.font = KENConstants.Fonts.title(size: 18)
    ...
    private func configureData() {
        ...
        KENImageLoader.shared.loadImage(from: post.userAvatarURL) { [weak self] img in
