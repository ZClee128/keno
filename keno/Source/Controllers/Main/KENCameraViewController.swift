...
class KENCameraViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        KENImageLoader.shared.loadImage(from: "1.jpg") { [weak self] img in
    ...
    private func showPreview() {
        ...
        let previewVC = KENPhotoPreviewViewController()
...
class KENPhotoPreviewViewController: UIViewController {
    ...
    private func performPost() {
        ...
        if let img = self.image {
            KENPostManager.shared.addPost(image: img, caption: "My Story Update!")
        }
