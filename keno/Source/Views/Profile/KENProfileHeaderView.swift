...
class KENProfileHeaderView: UIView {
    ...
    private let nameLabel: UILabel = {
        let label = UILabel()
        label.font = KENConstants.Fonts.header(size: 20)
    ...
    override init(frame: CGRect) {
        ...
        backgroundColor = KENConstants.Colors.cardBackground
        setupUI()
    }
    ...
    private func createStatView(count: String, title: String, customLabel: UILabel? = nil) -> UIView {
        ...
        countLabel.font = KENConstants.Fonts.title(size: 16)
        countLabel.textColor = KENConstants.Colors.textPrimary
        countLabel.textAlignment = .center
        
        let titleLabel = UILabel()
        titleLabel.text = title
        titleLabel.font = KENConstants.Fonts.caption(size: 12)
        titleLabel.textColor = KENConstants.Colors.textSecondary
    ...
    func configure(name: String, bio: String, avatarURL: String, postCount: Int) {
        ...
        KENImageLoader.shared.loadImage(from: avatarURL) { [weak self] image in
