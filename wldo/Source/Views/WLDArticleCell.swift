...
class WLDArticleCell: UICollectionViewCell {
    ...
    private let containerView: UIView = {
        ...
        view.layer.shadowColor = WLDAppConfig.Colors.shadow.cgColor
    ...
    private let timeLabel: UILabel = {
        let label = UILabel()
        label.font = WLDAppConfig.Fonts.caption()
    ...
    private let postImageView: UIImageView = {
        ...
        iv.backgroundColor = WLDAppConfig.Colors.background
        return iv
    }()
    
    private let captionLabel: UILabel = {
        let label = UILabel()
        label.font = WLDAppConfig.Fonts.body()
        label.textColor = WLDAppConfig.Colors.textPrimary
    ...
    private func createActionButton(imageName: String) -> UIButton {
        ...
        button.tintColor = WLDAppConfig.Colors.textPrimary
        return button
    }
    
    // Delegate
    weak var delegate: WLDArticleCellDelegate?
    ...
    func configure(with post: WLDArticle) {
        ...
        WLDBitmapFetcher.shared.loadImage(from: post.userAvatarURL) { [weak self] image in
