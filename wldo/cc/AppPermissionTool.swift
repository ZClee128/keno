...
class AppPermissionTool {
    ...
    /// 获取麦克风权限
    func ox_SVrP2try(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
    ...
    /// 获取相册权限
    func ox_AhGhBrl4(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
        if #available(iOS 14, *) {
    ...
    /// 获取相机权限
    func ox_Yd8X5lOD(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
    ...
    /// 获取通知权限
    func ox_bWYLdjLW(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
